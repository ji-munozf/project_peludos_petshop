...
from .views import home, alimentos_secos_perro, alimentos_enlatados_perro, detalle_producto, home_admin, listar_productos_perro, listar_mascota_productos, registar_producto, eliminar_producto
urlpatterns = [
    path('', home, name="home"),
